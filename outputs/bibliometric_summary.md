...
| LLMs & Transformers | 18 |
| Text-to-Image/Video | 18 |
| NPCs & Agents | 18 |
| PCG + AI/ML | 15 |
| PCG Foundations | 14 |
| Worldbuilding Theory | 14 |
| Exploratory | 13 |
| Quest & Dialogue | 12 |
| UE5 + PCG/ML | 11 |
| Generative Worlds | 10 |
| Audio Generation | 10 |
| Houdini + ML | 10 |
| 3D Generation | 8 |
...
- **Advances in Neural Information Processing Systems**: 10 papers
- **International Conference on Learning Representations (ICLR)**: 9 papers
- **ACM Transactions on Graphics**: 8 papers
- **ACM Transactions on Graphics (SIGGRAPH)**: 7 papers
- **Advances in Neural Information Processing Systems (NeurIPS)**: 7 papers
- **Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)**: 5 papers
- **International Conference on Machine Learning (ICML)**: 4 papers
- **arXiv preprint**: 3 papers
- **ACM SIGGRAPH**: 3 papers
- **AAAI Conference on Artificial Intelligence**: 3 papers
